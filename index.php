  ...
  <section class="login-box">
    ...
    <div class="login-box-body" ng-controller="LoginController">
      ...
      <form id="login-form" action="login.php" method="post">       
        ...
        <button type="submit" id="login-btn" class="btn btn-success btn-block btn-flat" data-loading-text="<?=trans('button_sign_in_loading')?>...">
        ...
        <div class="modal-content">
          <form action="#" method="post" accept-charset="utf-8">
            ...
            <div class="modal-body">
              ...
              <input id="email" type="email" name="email" placeholder="<?=trans('placeholder_forgot_password')?>" autocomplete="off" class="form-control">
            </div>
            <div class="modal-footer">
              <button data-dismiss="modal" class="btn btn-warning pull-left" type="button"><?php echo trans('button_close'); ?></button>
              <button id="reset-btn" name="reset-btn" class="btn btn-success" type="submit" data-loading-text="<?=trans('email_sending')?>...">
