...
<body class="lockscreen">
  ...
  <div class="lockscreen-wrapper">
    <h4 class="text-center text-green">PUVECA Online <small class="text-muted"><?php //echo settings('version');?></small></h4>
    <br>
    ...
    <div class="lockscreen-item">
      ...
      <form class="lockscreen-credentials" action="" method="post" autocomplete="off">
        <div class="input-group">
          <input class="form-control" type="password" name="password" placeholder="<?=trans('password')?>" autocomplete="off" autofocus>
    ...
    <div class="help-block text-center">
      <?=trans('lockscreen_enter_password_or_session')?>
    </div>
    <div class="text-center">
      <a href="index.php" style="font-size:1.8rem;color:green;text-decoration:underline;"><small><?=trans('or')?></small> <?=trans('lockscreen_sing_different_user')?></a>
    </div>
    <div class="lockscreen-footer text-center">
      <div class="copyright" style="font-size:1.2rem;">Copyright © <?php echo date('Y'); ?> <a href="#">PUVECA</a></div>
    </div>
  </div>
