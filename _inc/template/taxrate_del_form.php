...
<form class="form-horizontal" id="taxrate-del-form" action="taxrate.php" method="post">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <button id="taxrate-delete" data-form="#taxrate-del-form" data-datatable="#taxrate-taxrate-list" class="btn btn-danger" name="btn_edit_box" data-loading-text="Eliminando...">
