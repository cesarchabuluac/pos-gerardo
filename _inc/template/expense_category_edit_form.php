...
<form class="form-horizontal" id="expense-category-form" action="expense_category.php" method="post">
  ...
  <div class="box-body">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-7">
          <input type="text" class="form-control" id="category_name" ng-model="codeName" ng-init="codeName='<?php echo $expense_category['category_slug'] ? $expense_category['category_slug'] : $expense_category['category_name']; ?>'" value="<?php echo $expense_category['category_name']; ?>" name="category_name" required>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-7">
          <input type="text" class="form-control" id="category_slug" value="<?php echo $expense_category['category_slug'] ? $expense_category['category_slug'] : "{{ codeName | strReplace:' ':'_' | lowercase }}"; ?>" name="category_slug" required>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-7">
          <button id="expense-category-update" data-form="#expense-category-form" data-datatable="#category-category-list" class="btn btn-info" name="btn_edit_expense_category" data-loading-text="Actualizando...">
