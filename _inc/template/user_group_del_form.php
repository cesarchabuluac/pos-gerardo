  ...
  <div class="box-body">
    ...
    <div class="form-group">
      <div class="col-sm-12 text-center">
        <button id="user-group-delete" data-form="#user-group-del-form" data-datatable="#user-group-list" class="btn btn-danger" name="btn_edit_user-group" data-loading-text="Eliminando...">
