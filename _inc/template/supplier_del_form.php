...
<form class="form-horizontal" id="supplier-del-form" action="supplier.php" method="post">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <button id="supplier-delete" data-form="#supplier-del-form" data-datatable="#supplier-supplier-list" class="btn btn-danger" name="btn_edit_supplier" data-loading-text="Eliminando...">
