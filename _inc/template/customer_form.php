...
<form class="form-horizontal" id="customer-form" action="customer.php" method="post">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-7">
        <button id="customer-update" data-form="#customer-form" data-datatable="#customer-customer-list" class="btn btn-block btn-info" name="btn_edit_customer" data-loading-text="Actualizando...">
