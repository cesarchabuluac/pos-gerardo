<form class="form-horizontal" id="payment-form" action="installment.php" method="post">
  ...
  <div class="box-body">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-7">
          <button id="payment-update" data-form="#payment-form" data-datatable="#payment-payment-list" class="btn btn-info" name="btn_edit_payment" data-loading-text="Actualizando...">
