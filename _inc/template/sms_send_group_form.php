<form id="sms-group-send-form" class="form-horizontal" action="sms/index.php" method="post">
  ...
  <div class="box-body">
    ...
    <div ng-show="peopleArray.length" class="form-group">
      ...
      <div class="col-sm-6">
        <textarea class="form-control" id="message" name="message" rows="4" required>Hola, [name]</textarea>
        <i>Max. caracteres: 160</i>
        <p>
          <kbd>[name]</kbd>
        </p>
      </div>
    ...
    <div ng-show="peopleArray.length" class="form-group">
      ...
      <div class="col-sm-6">
        <button class="btn btn-block btn-info" id="sms-group-send-btn" type="submit" data-form="#sms-group-send-form" data-loading-text="Enviando...">
