  ...
  <div class="box-body">
    ...
    <div class="form-group">
      <div class="col-sm-12 text-center">
        <button id="expense-category-delete" data-form="#expense-category-del-form" data-datatable="#category-category-list" class="btn btn-danger" name="btn_edit_expense_category" data-loading-text="Eliminando...">
