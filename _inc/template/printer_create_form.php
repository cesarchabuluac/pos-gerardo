<form id="create-printer-form" class="form form-horizontal" action="printer.php" method="post" enctype="multipart/form-data">
  ...
  <div class="box-body">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-6">
          <select class="form-control select2" name="type" id="printer-type" ng-model="printerType">
      ...
      <div ng-show="!isNetwork" class="form-group">
        <label for="path" class="col-sm-3 control-label">
          <?php echo trans('label_path'); ?><i class="required">*</i>
        </label>
        <div class="col-sm-6">
          ...
          <p>
            <small>
              <b>Para Windows:</b> (Impresora local USB, serie o paralela): Comparta la impresora e ingrese el nombre compartido para su impresora aquí o para Server Message Block (SMB): ingrese como un formato smb://url como <span class="text-blue">smb://computername/Receipt Printer</span> <br>
              <b>Para Linux:</b> Paralela como <span class="text-blue">/dev/lp0</span>, USB as <span class="text-blue">/dev/usb/lp1</span>, USB-Serial como <span class="text-blue">/dev/ttyUSB0</span>, Serial como <span class="text-blue">/dev/ttyS0</span>
            </small>
          </p>
        </div>
      </div> 
      ...
      <div ng-show="isNetwork" class="form-group">
        <label for="ip_address" class="col-sm-3 control-label">
          <?php echo trans('label_ip_address'); ?><i class="required">*</i>
        </label>
        <div class="col-sm-6">
      ...
      <div ng-show="isNetwork" class="form-group">
        <label for="port" class="col-sm-3 control-label">
          <?php echo trans('label_port'); ?><i class="required">*</i>
        </label>
        <div class="col-sm-6">
          ...
          <p>
            <i>La mayoría de las impresoras están abiertas en el puerto 9100</i>
          </p>
        </div>
      </div> 
