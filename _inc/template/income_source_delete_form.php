  ...
  <div class="box-body">
    ...
    <div class="form-group">
      <div class="col-sm-12 text-center">
        <button id="income-source-delete" data-form="#income-source-del-form" data-datatable="#source-source-list" class="btn btn-danger" name="btn_edit_income_source" data-loading-text="Eliminando...">
