  ...
  <div class="box-body">
    ...
    <div class="form-group">
      <div class="col-sm-6 col-sm-offset-3 text-center">            
        <button id="update-order-submit" class="btn btn-block btn-lg btn-info" data-form="#form-order" data-datatable="#order-order-list" name="submit" data-loading-text="Actualizando...">
