  ...
  <input type="hidden" id="printer_id" name="printer_id" value="<?php echo $printer['printer_id']; ?>">
    ...
    <div class="form-group">
      <div class="col-sm-12 text-center">
        <button id="printer-delete" data-form="#printer-del-form" data-datatable="#printer-printer-list" class="btn btn-danger" name="btn_edit_printer" data-loading-text="Eliminando...">
