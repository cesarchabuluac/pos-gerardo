...
<form class="form-horizontal" id="taxrate-form" action="taxrate.php" method="post">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">            
        <button id="taxrate-update" class="btn btn-info"  data-form="#taxrate-form" data-datatable="#taxrate-taxrate-list" name="btn_edit_customer" data-loading-text="Actualizando...">
