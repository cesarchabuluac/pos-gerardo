						...
						<tbody>
							...
							foreach ($returns as $row) : ?>
								<tr>
									...
									<t/r> <?php $inc++;
										endforeach; ?> </tbody> </table> </div> <?php endif; ?> <?php if (!empty($payments)) : ?> <h4><?php echo trans('text_payments'); ?></h4>
										<div class="table-responsive">
											<table class="table table-bordered margin-b0 table-condensed">
												<thead>
													<tr class="bg-gray">
														...
														<tr class="bt-1 <?php echo $color; ?>">
															<td class="w-50 text-right">
																<?php if ($row['type'] == 'return') : ?>
																	<small><i>Regreso en</i></small> <?php echo $row['created_at']; ?> <small><i>por</i></small> <?php echo get_the_user($row['created_by'], 'username'); ?>
																<?php elseif ($row['type'] == 'change') : ?>
																	<small><i>Cambio en</i></small> <?php echo $row['created_at']; ?> <small><i>por</i></small> <?php echo get_the_user($row['created_by'], 'username'); ?>
																<?php elseif ($row['type'] == 'discount') : ?>
																	<small><i>Descuento en</i></small> <?php echo $row['created_at']; ?> <small><i>por</i></small> <?php echo get_the_user($row['created_by'], 'username'); ?>
																<?php elseif ($row['type'] == 'due_paid') : ?>
																	...
																	<?php endif; ?>
																	por <?php echo get_the_user($row['created_by'], 'username'); ?>
																<?php else : ?>
																	<small><i>Pagado en</i></small> <?php echo $row['created_at']; ?>
																	<?php if ($row['pmethod_id']) : ?>
																		(via <?php echo get_the_pmethod($row['pmethod_id'], 'name'); ?>)
																	<?php endif; ?>
																	por <?php echo get_the_user($row['created_by'], 'username'); ?>
