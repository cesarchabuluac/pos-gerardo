  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8">
          <button id="printer-update" data-form="#printer-form" data-datatable="#printer-printer-list" class="btn btn-info" name="btn_edit_printer" data-loading-text="Actualizando...">
