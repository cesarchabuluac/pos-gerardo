...
<form class="form-horizontal" id="pmethod-form" action="pmethod.php" method="post">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">            
        <button id="pmethod-update" class="btn btn-info"  data-form="#pmethod-form" data-datatable="#pmethod-pmethod-list" name="btn_edit_customer" data-loading-text="Actualizando...">
