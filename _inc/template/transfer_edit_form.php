<form id="transfer-edit-form" class="form-horizontal" action="transfer.php" method="post">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">            
        <button id="transfer-update" class="btn btn-info"  data-form="#transfer-edit-form" data-datatable="#transfer-transfer-list" name="transfer-update" data-loading-text="Actualizando...">
