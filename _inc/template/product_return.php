...
<form id="product-return-form" class="form-horizontal" action="product_return.php" method="post">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <button id="save-product-return" data-form="#product-return-form" data-datatable="#product-product-list" type="submit" class="btn btn-info" name="btn_product_return" data-loading-text="Actualizando...">
