<form id="loan-edit-form" class="form-horizontal" action="loan.php" method="post" enctype="multipart/form-data">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
        <select class="form-control select2" name="loan_from">
          ...
          <option value="others" <?php echo $loan['loan_from'] == 'others' ? 'selected' : null;?>>Otros</option>
       </select>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">            
        <button id="loan-update" class="btn btn-block btn-info"  data-form="#loan-edit-form" data-datatable="#loan-loan-list" name="btn_edit_loan" data-loading-text="Actualizando...">
