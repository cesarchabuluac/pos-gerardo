...
<form class="form-horizontal" id="product-del-form" action="product.php" method="post">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      <div class="col-sm-8 col-sm-offset-2">
        <button id="product-delete-submit" data-form="#product-del-form" data-datatable="#product-product-list" class="btn btn-danger" name="submit" data-loading-text="Eliminando...">
