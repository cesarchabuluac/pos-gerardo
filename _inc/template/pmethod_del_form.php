...
<form class="form-horizontal" id="pmethod-del-form" action="pmethod.php" method="post">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <button id="pmethod-delete" data-form="#pmethod-del-form" data-datatable="#pmethod-pmethod-list" class="btn btn-danger" name="btn_edit_box" data-loading-text="Eliminando...">
