  ...
  <div class="box-body">
    <div class="row">
      <div class="col-sm-6 col-sm-offset-3">
        ...
        <br>
        <button id="customer-delete" data-form="#customer-del-form" data-datatable="#customer-customer-list" class="btn btn-block btn-danger" name="btn_edit_customer" data-loading-text="Eliminando...">
