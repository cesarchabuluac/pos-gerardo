...
<form class="form-horizontal" id="giftcard-form" action="giftcard.php" method="post">
  ...
  <div class="box-body">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">            
        <button id="giftcard-update" class="btn btn-info"  data-form="#giftcard-form" data-datatable="#giftcard-giftcard-list" name="btn_edit_customer" data-loading-text="Actualizando...">
