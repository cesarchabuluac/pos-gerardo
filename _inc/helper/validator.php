...
function checkPasswordStrongness($password)
{
    ...
    if (strlen($password) < 8) {
        $err = "Su contraseña debe contener al menos 8 caracteres!";
    }
    elseif(!preg_match("#[0-9]+#",$password)) {
        $err = "Su contraseña debe contener al menos 1 número!";
    }
    elseif(!preg_match("#[A-Z]+#",$password)) {
        $err = "Su contraseña debe contener al menos 1 letra mayúscula!";
    }
    elseif(!preg_match("#[a-z]+#",$password)) {
        $err = "Su contraseña debe contener al menos 1 letra minúscula!";
    }
    if (!$err) {
        return 'ok';
    }
