...
$demo_text = 'Esta es una versión demo. Los datos se restablecerán cada 6 horas.. <a style="color: #b3ffe0;font-weight: bold;border: 1px solid #fff;padding: 5px 10px;text-decoration: none;text-transform: uppercase;" href="http://bit.ly/Modern-POS">Comprar ahora &rarr;</a>';
?>
<!DOCTYPE html>
