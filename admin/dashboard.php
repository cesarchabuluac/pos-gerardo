        ...
        <div class="box">
          <div class="box-body">
            ...
            <div class="alert alert-warning mb-0">
              <p><span class="fa fa-fw fa-info-circle"></span> Version <span class="label label-info"><?php echo settings('update_version');?></span> ya está disponible. <a href="<?php echo settings('update_link');?>" target="_blink">Lea el registro de cambios y las instrucciones de actualización aquí</a></p>
            </div>
            <?php endif; ?>
            <?php if (DEMO) : ?>
