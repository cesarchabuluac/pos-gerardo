	    ...
	    <div class="box">
	      <div class="box-body">
	        ...
	        <div class="alert alert-warning mb-0">
	          <p><span class="fa fa-fw fa-info-circle"></span> La configuración de correo electrónico y FTP está deshabilitada en la versión demo</p>
	        </div>
	      </div>
	    </div>
	    <?php endif; ?>
					...
					<div class="tab-pane<?php echo $tab_active == 'pos-setting' ? ' active' : null;?>" id="pos-setting">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								...
								<div class="well well-sm mb-0">
									<i>Para la instalación local de una sola máquina: el servidor PHP será la mejor opción y para la configuración del servidor en vivo o del servidor local (LAN): puede instalar el servidor de impresión PHP Pos localmente en cada máquina (recomendado) o usar la función de impresión del navegador web.</i>
								</div>
								<div class="well well-sm mb-0">
									<div class="form-group">
										<div class="col-sm-6">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<select id="email_driver" name="preference[email_driver]"> 
									...
									Utilice la función integrada de correo php ()
									</option>
						...
						<?php if (user_group_id() == 1 || has_permission('access', 'upload_logo')) : ?>
						    <div class="col-sm-4">	            
								<div class="upload-field" id="selectImage">
									...
									<button type="submit" class="btn btn-sm btn-warning btn-logo-upload" data-loading-text="Cargando...">
						...
						<?php if (user_group_id() == 1 || has_permission('access', 'upload_favicon')) : ?>
							<div class="col-sm-4">	            
								<div class="upload-field" id="selectFavicon">
									...
									<div class="message"></div>
									<button type="submit" class="btn btn-sm btn-warning btn-favicon-upload" data-loading-text="Cargando...">
										<span class="fa fa-fw fa-upload"></span> 
										<?php echo trans('button_upload'); ?>
									</button>
...
<h4><b>Trabajos Cron / Tareas programadas</b></h4>
