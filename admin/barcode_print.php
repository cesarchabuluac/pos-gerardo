              ...
              <div class="well well-sm">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <select name="per_page" class="form-control" id="per_page">
                        ...
                        <option value="40" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 40 ? 'selected' : 'selected';?>>40 por hoja (a4) (1.799" x 1.003")</option>
                        <option value="30" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 30 ? 'selected' : null;?>>30 por hoja (2.625" x 1")</option>
                        <option value="24" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 24 ? 'selected' : null;?>>24 por hoja (a4) (2.48" x 1.334")</option>
                        <option value="20" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 20 ? 'selected' : null;?>>20 por hoja (4" x 1")</option>
                        <option value="18" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 18 ? 'selected' : null;?>>18 por hoja (a4) (2.5" x 1.835")</option>
                        <option value="14" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 14 ? 'selected' : null;?>>14 por hoja (4" x 1.33")</option>
                        <option value="12" 
                          <?php if(isset($request->post['per_page']) && $request->post['per_page'] == 12) {
                            echo 'selected';
                          };?>
                        >12 por hoja (a4) (2.5" x 2.834")</option>
                        <option value="10" <?php echo isset($request->post['per_page']) && $request->post['per_page'] == 10 ? 'selected' : null;?>>10 por hoja (4" x 2")</option>
                      </select>
                    </div>
                  </div>
                  <div class="form-group mb-0">
                ...
                <div class="form-group">
                  <div class="col-sm-3 col-sm-offset-3 text-center">            
                    <button id="barcode-generate" class="btn btn-info btn-block" data-form="#form-barcode-generate" name="submit" data-loading-text="Generando...">
