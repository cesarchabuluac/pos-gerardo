    ...
    <div class="box">
      <div class="box-body">
        ...
        <div class="alert alert-warning mb-0">
          <p><span class="fa fa-fw fa-info-circle"></span> Las funciones de copia de seguridad / restauración están deshabilitadas en la versión demo</p>
        </div>
      </div>
    </div>
    <?php endif; ?>
          ...
          <?php if(user_group_id() == 1 || has_permission('access', 'restore')) : ?>
            <div class="tab-pane" id="restore">
              <div class="alert alert-info">
                <p><span class="fa fa-fw fa-info-circle"></span> El proceso de restauración puede tardar varios minutos en completarse. Nunca cierre su navegador antes del proceso, de lo contrario, el sistema puede romperse y no funcionar correctamente.</p>
              </div>
              <form class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <p class="text-blue">** Solo se acepta el archivo .sql</p>
                  </div>
                </div>
                <div class="form-group">
                  <div class="col-sm-6 col-sm-offset-2">
                    <button type="button" id="button-restore" class="btn btn-block btn-lg btn-warning" data-loading-text="Restaurando...">
