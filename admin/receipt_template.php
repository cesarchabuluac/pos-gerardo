			...
			<div class="app-container">
				<div class="app-row">
					...
					<main class="app-col app-content">
						...
						<div class="tags">
							<h4><b><?php echo trans('text_template_tags');?></b>. Uso:<code>{{ logo }}</code></h4>
							<?php 
							$template_tags = get_postemplate_empty_data();
							foreach ($template_tags as $key => $val):?> 
								<?php if (is_array($val)):?>
									<h4><b class="text-red"><?php echo ucfirst(str_replace('_', ' ', $key));?></b> Etiquetas de bucle. Uso:<code>{{ <?php echo $key;?> }} {{ sl }} {{ /<?php echo $key;?> }}</code></h4>
